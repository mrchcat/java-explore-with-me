...
### Тесты Postman:
Обратите внимание, что создание вспомогательных сущностей происходит через запросы в папках "Подготовка объектов", в остальном тесты сгруппированы по контроллерам.
...
Лучше всего запустить пакет "Comments" целиком. 