...
CREATE TABLE IF NOT EXISTS compilation_event (
  ...
  CONSTRAINT FK_FOREIGN_COMPILATION_ID FOREIGN KEY (compilation_id) REFERENCES compilations(id) ON DELETE CASCADE,
  CONSTRAINT FK_FOREIGN_EVENT_ID FOREIGN KEY (event_id) REFERENCES events (id) ON DELETE CASCADE
);
...
CREATE TABLE  IF NOT EXISTS comments (
  ...
  CONSTRAINT FK_FOREIGN_COMMENTS_EVENT_ID  FOREIGN KEY (event_id) REFERENCES events(id) ON DELETE CASCADE,
  CONSTRAINT FK_FOREIGN_COMMENTS_AUTHOR_ID FOREIGN KEY (author_id) REFERENCES users(id) ON DELETE CASCADE,
  CONSTRAINT UNIQUE_AUTHOR_EVENT UNIQUE(event_id,author_id)
);
